...
import { Orientation, MessageType } from "../shared/types.js";
...
export class GameLogic {
    constructor() {
        this.gridSizeXY = 10;
        this.gridLayers = 4;
        this.myId = UNINITIALIZED;
        this.activePlayerId = UNINITIALIZED;
        this.cursor = {
            pos: [1, 0, 0],
    ...
    IsMyTurn() {
        ...
        return ((_a = this.getActivePlayer()) === null || _a === void 0 ? void 0 : _a.id) == this.myId;
    }
    setActivePlayer(id) {
    ...
    convertCursorToServerFence(pos, orientation) {
        let c;
        switch (orientation) {
            case Orientation.Flat:
