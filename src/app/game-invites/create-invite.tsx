        ...
        return (
            <>
                ...
                <div className="flex flex-col">
                    ...
                    <input autoComplete="new-password" className="bg-transparent rounded-none border-b-2 outline-none" type="text" ref={friendRef} placeholder="username" defaultValue={username} />
