...
export default function Home() {
  ...
  return (
    <div>
      ...
      <AddRightBorder>
      <h1 className="font-display backdrop-blur bg-blue-200 bg-opacity-10 py-4 pl-10 md:pl-20 lg:pl-40 pr-10 text-gray-200 font-bold text-center text-2xl md:text-6xl">
        QUORIDOR ONLINE
      </h1>
      </AddRightBorder>
      </div>
